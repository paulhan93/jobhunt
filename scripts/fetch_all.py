    ...
    with get_conn() as conn:
        ...
        with httpx.Client(follow_redirects=True) as client:
            for c in companies:
                ...
                # Closed detection: anything still open for this company that
                # wasn't in the response has been filled or pulled. Guarded
                # against truncated responses mass-closing live jobs.
